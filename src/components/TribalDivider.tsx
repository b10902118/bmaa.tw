/**
 * TribalDivider Component
 *
 * Replicates the custom Elementor divider with the dots_tribal pattern.
 * Uses a repeating SVG background mask.
 */
const TribalDivider = () => {
  return (
    <div className="w-full py-8 md:px-[8%]">
      <div
        className="h-[20px] w-full bg-[#828F66]"
        style={{
